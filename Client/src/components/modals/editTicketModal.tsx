...
interface EditTicketModalProps {
    open: boolean;
    onEdit: (ticket: TicketModel,
        setError: (error: string) => void) => void;
    onCancel: () => void;
}

const EditTicketModal: React.FC<EditTicketModalProps> = ({ open, onEdit, onCancel }) => {
